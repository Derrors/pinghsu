...
<article class="main-content <?php if ($this->options->postshowthumb == 'able'): ?>post-page<?php else: ?>page-page<?php endif; ?>" itemscope itemtype="http://schema.org/Article">
	<div class="post-header">
		...
		<div class="post-data">
			<time datetime="<?php $this->date('c'); ?>" itemprop="datePublished"><i class="fa fa-clock-o" aria-hidden="true"></i> <?php $this->date('Y年m月d日'); ?></time>&nbsp;<i class="fa fa-tags" aria-hidden="true"></i> <?php $this->category(''); ?>&nbsp;<i class="fa fa-comments-o" aria-hidden="true"></i> <a href="#comments"><?php $this->commentsNum(_t('0次评论'), _t('1次评论'), _t('%d次评论')); ?>&nbsp;<i class="fa fa-eye" aria-hidden="true"></i> <?php _e(getViewsStr($this));?>次阅读</a>&nbsp;<?php art_count($this->cid); ?>
		</div>
	</div>
	<div id="post-content" class="post-content" itemprop="articleBody">
		...
		<p class="post-info">
			本文由 <a href="<?php $this->author->permalink(); ?>"><?php $this->author() ?></a> 创作，采用 <a href="https://creativecommons.org/licenses/by/4.0/" target="_blank" rel="external nofollow"><i class="fa fa-creative-commons" aria-hidden="true"></i> 知识共享署名4.0</a> 国际许可协议.
			<br>最后编辑时间: <?php echo date('Y年m月d日 H:i.' , $this->modified); ?>
		</p>
	</div>
</article>
...
<div id="post-bottom-bar" class="post-bottom-bar">
	<div class="bottom-bar-inner">
		<div class="bottom-bar-items social-share left">
			<span class="bottom-bar-item">Share to: </span>
			...
			<span class="bottom-bar-item bottom-bar-qrcode"><a href="https://api.dongyunit.com/qrcode?content=<?php echo urlencode($this->permalink()); ?>" target="_blank" rel="nofollow">WeChat</a></span>
		</div>
				...
				<div class="post-list-item-container">
					<div class="item-label">
						...
						<div class="item-meta clearfix">
							...
							<div class="item-meta-ico bg-ico-web" style="background: url(<?php $relatedPosts->options->themeUrl('images/bg-ico.png'); ?>) 
							no-repeat;background-size: 40px auto;"></div>
